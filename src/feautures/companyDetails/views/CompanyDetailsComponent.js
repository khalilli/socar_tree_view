        ...
        <main className="content">
            ...
            <form className="content-form">
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-9 flex-wrap country-row">
                        <div className="col-sm-2">
                            <span className="deleteicon">
                                <Autocomplete
                                    ...
                                    onChange={e =>
                                        props.setCountryOfOperation(
                                            e.target.value
                                        )
                                    }
                                    onSelect={val =>
                                        props.setCountryOfOperation(val)
                                    }
                                />
                                <span className="delete-span">x</span>
                            </span>
                        </div>
                        <button className="col-sm-1 add-button margin-left">
                            Add{' '}
                            <i
                                className="fa-solid fa-plus"
                                style={{ marginLeft: '5px' }}
